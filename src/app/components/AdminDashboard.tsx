...
export default function AdminDashboard() {
  ...
  const stats = [
    { label: 'Total Reports', value: 1247, change: '+12%', icon: <FileText className="w-6 h-6" />, color: 'bg-blue-100 text-blue-700' },
    { label: 'Active Lost Cases', value: 342, change: '+8%', icon: <AlertTriangle className="w-6 h-6" />, color: 'bg-red-100 text-red-700' },
    { label: 'Found Cases', value: 198, change: '+15%', icon: <CheckCircle className="w-6 h-6" />, color: 'bg-teal-100 text-teal-700' },
    { label: 'Reunited', value: 89, change: '+23%', icon: <CheckCircle className="w-6 h-6" />, color: 'bg-emerald-100 text-emerald-700' },
    { label: 'Flagged Posts', value: 12, change: '-5%', icon: <Flag className="w-6 h-6" />, color: 'bg-orange-100 text-orange-700' },
    { label: 'Active Users', value: 3542, change: '+18%', icon: <Users className="w-6 h-6" />, color: 'bg-purple-100 text-purple-700' },
  ];
  ...
  const recentActivity = [
    { action: 'Report approved', user: 'admin_maria', target: 'Luna report', time: '5 min ago' },
    { action: 'Post flagged', user: 'system', target: 'Unknown cat', time: '15 min ago' },
    { action: 'User banned', user: 'admin_juan', target: 'spam_account', time: '1 hour ago' },
    { action: 'Report removed', user: 'admin_maria', target: 'Duplicate post', time: '2 hours ago' },
  ];
              ...
              >
                <div className="p-6 border-b border-slate-200">
                  ...
                  <p className="text-sm text-slate-600 mt-1">
                    Review and moderate reports flagged by the community or system
                  </p>
                </div>
                  ...
                  {flaggedPosts.map((post) => (
                    <div key={post.id} className="p-6 hover:bg-slate-50 transition-colors">
                      <div className="flex items-start justify-between mb-3">
                        <div>
                          <div className="flex items-center gap-2 mb-1">
                            <h3 className="font-semibold text-slate-900">{post.petName}</h3>
                            <span className="px-2 py-1 bg-orange-100 text-orange-700 rounded-full text-xs font-medium">
                              Flagged
                            </span>
                          </div>
                          <p className="text-sm text-slate-600">
                            Reporter: {post.reporter} • {post.location}
                          </p>
                        </div>
                      ...
                      <div className="flex items-center gap-2 mb-4">
                        ...
                        <span className="text-sm text-slate-700">Reason: {post.reason}</span>
                      </div>
              ...
              >
                ...
                <div className="aspect-[2/1] bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl flex items-center justify-center mb-6">
                  <div className="text-center text-slate-500">
                    ...
                    <p className="text-sm">Reports Analytics Chart</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="p-4 bg-slate-50 rounded-xl">
                    <div className="text-2xl font-bold text-slate-900 mb-1">2.4 days</div>
            ...
            {selectedTab === 'activity' && (
              ...
              >
                <div className="p-6 border-b border-slate-200">
                  ...
                  <p className="text-sm text-slate-600 mt-1">Recent moderation actions and system events</p>
                </div>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-slate-600">Today's Reports</span>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-slate-600">Active Moderators</span>
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl border border-slate-200 p-6"
            >
              <h3 className="font-semibold text-slate-900 mb-4">Active Moderators</h3>
              <div className="space-y-3">
                {['Maria Santos', 'Juan Reyes', 'Sofia Cruz'].map((mod, index) => (
                  <div key={index} className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-slate-900">{mod}</p>
