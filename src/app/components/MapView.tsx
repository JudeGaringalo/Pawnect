...
export default function MapView() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="sticky top-0 z-[9999] bg-white border-b border-slate-200 shadow-sm">
          ...
          <div className="lg:col-span-8">
            <div className="bg-white rounded-3xl border border-slate-200 overflow-hidden shadow-sm">
              <div className="h-[680px] w-full relative">
                ...
                {loading && (
                  <div className="absolute inset-0 bg-white/70 backdrop-blur-sm flex items-center justify-center z-0">
